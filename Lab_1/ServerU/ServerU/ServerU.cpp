...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	#pragma region
		...
		serv.sin_addr.s_addr = inet_addr("172.20.10.4");	
	...
	#pragma endregion
		...
		while (count != 11)
		{
			...
			averageCorrection[count - 1] = setsincro.correction;	// заносим в массив
			...
			cout << tm.wMonth << "." << tm.wDay << ".2022  -  " << tm.wHour + 3 << ":" << tm.wMinute << ":" << tm.wSecond << "." << tm.wMilliseconds << "\n";
